...
import { LayoutDashboard, BookOpen, ClipboardList, LogOut, Menu, X, Settings } from "lucide-react"
...
export function TeacherSidebar() {
  ...
  const navItems = [
    ...
    { href: "/teacher/courses", label: t("teacher.myCourses"), icon: BookOpen },
    { href: "/teacher/reports", label: t("nav.reports"), icon: ClipboardList },
  ...
  return (
    <>
      ...
      >
        <div className="p-6">
          <h1 className="text-2xl font-bold text-green-600 mb-8">AMS Teacher</h1>
