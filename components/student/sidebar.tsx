...
import { LayoutDashboard, BookOpen, BarChart3, User, LogOut, Menu, X, Settings, Award } from "lucide-react"
...
export function Sidebar() {
  ...
  const navItems = [
    ...
    { href: "/student/courses", label: t("teacher.myCourses"), icon: BookOpen },
    { href: "/student/progress", label: t("report.students"), icon: BarChart3 },
    { href: "/student/summaries", label: t("nav.summaries"), icon: BookOpen },
    { href: "/student/certificates", label: t("nav.certificates"), icon: Award },
    { href: "/student/profile", label: t("common.details"), icon: User },
  ...
  return (
    <>
      ...
      >
        <div className="p-6">
          <h1 className="text-2xl font-bold text-blue-600 mb-8">AMS</h1>
